...
public class ShuTextView extends View {
...
//    BitmapDrawable drawable = (BitmapDrawable) getBackground();
    ...
    public ShuTextView(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public ShuTextView(Context context, AttributeSet attrs) {
        super(context, attrs);
        matrix = new Matrix();
    ...
    public void setText(int size, String text) {
        this.text = text;
        this.TextLength = text.length();
        mFontSize = size;
        if (mTextHeight > 0) GetTextInfo();
