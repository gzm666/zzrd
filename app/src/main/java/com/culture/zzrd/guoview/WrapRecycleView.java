...
import com.culture.zzrd.adapter.WrapRecycleAdapter;
...
public class WrapRecycleView extends RecyclerView {
    // 包裹了一层的头部底部Adapter
    private WrapRecycleAdapter mWrapRecyclerAdapter;
    // 这个是列表数据的Adapter
    ...
    public WrapRecycleView(Context context,  AttributeSet attrs, int defStyle) {
    ...
    public void setAdapter(Adapter adapter) {
        ...
        if (adapter instanceof WrapRecycleAdapter) {
            mWrapRecyclerAdapter = (WrapRecycleAdapter) adapter;
        } else {
            mWrapRecyclerAdapter = new WrapRecycleAdapter(adapter);
        }
